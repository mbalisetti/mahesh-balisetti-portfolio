        ...
        >
          ...
          <div className="relative p-8 rounded-2xl bg-slate-900/40 border border-white/10 backdrop-blur-xl shadow-2xl">
            ...
            <p className="text-slate-300 text-lg leading-relaxed mb-6 font-light">
              <span className="text-white font-medium">Software Engineer</span> with 2+ years of experience designing and developing enterprise applications in banking and financial services domains. Skilled in Actimize, Java, Spring Boot, REST API integration, microservices, and cloud-native application development. Experienced in system customization, application migration. Strong understanding of SDLC and Agile methodologies, focused on building scalable, reliable, and high-performance systems.
            </p>
          </div>
